...
> This changelog covers releases made from the standalone [SAP/cloud-foundry-tools-api](https://github.com/SAP/cloud-foundry-tools-api) repository, before the package was migrated into the app-studio-toolkit monorepo. Newer entries are generated by Changesets in `CHANGELOG.md`.
