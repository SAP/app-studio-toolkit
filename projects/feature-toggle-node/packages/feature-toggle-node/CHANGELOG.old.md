...
> This changelog covers releases made from the standalone [SAP/feature-toggle-node](https://github.com/SAP/feature-toggle-node) repository, before the package was migrated into the app-studio-toolkit monorepo. Newer entries are generated by Changesets in `CHANGELOG.md`.
