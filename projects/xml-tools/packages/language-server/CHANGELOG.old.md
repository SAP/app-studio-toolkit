> **Historic changelog.** This records changes made while the project lived in the
> standalone [SAP/xml-tools](https://github.com/SAP/xml-tools) repository, before it was
> migrated into [SAP/app-studio-toolkit](https://github.com/SAP/app-studio-toolkit).
> Newer entries are generated by Changesets in `CHANGELOG.md`.
...
# [1.2.0](https://github.com/SAP/xml-tools/compare/@xml-tools/language-server@1.1.1...@xml-tools/language-server@1.2.0) (2026-02-11)
