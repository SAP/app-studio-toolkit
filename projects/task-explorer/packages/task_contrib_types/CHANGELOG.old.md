...
> This file contains the changelog history from the standalone [SAP/task-explorer](https://github.com/SAP/task-explorer) repository, prior to migration into this monorepo. New changes are recorded in this package's `CHANGELOG.md`.
