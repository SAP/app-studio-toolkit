...
describe("App.vue", () => {
  ...
  it("initRpc - method", () => {
    ...
    expect(registerMethodSpy).toHaveBeenCalledWith({
      func: wrapper.vm.showCollections,
      thisArg: wrapper.vm,
      name: "showCollections",
    });
    expect(registerMethodSpy).toHaveBeenCalledWith({
      func: wrapper.vm.changeItemsState,
      thisArg: wrapper.vm,
      name: "changeItemsState",
    });
  ...
  it("change not exist item's state", () => {
    ...
    const ret = wrapper.vm.changeItemsState([
      { fqid: notExistsItemFqid, readState: "READ" },
    ]);
  ...
  it("change exist item's state", () => {
    wrapper = initComponent(App);
    const secondNestedLevelItemFqid =
      "extName1.extPublisher1.secondNestedLevelItem";
    ...
    wrapper.vm.changeItemsState([
      { fqid: secondNestedLevelItemFqid, readState: "READ" },
    ]);
  ...
  it("find an item at third level", () => {
    const thirdNestedLevelItemFqid =
      "extName1.extPublisher1.thirdNestedLevelItem";
  ...
  it("onAction - method", () => {
    ...
    expect(invokeSpy).toHaveBeenCalledWith("performAction", [
      "fqid",
      1,
      "context",
    ]);
