...
describe("Items.vue", () => {
  ...
  test("component props", () => {
    wrapper = initComponent(
      Items,
      { items: [], filter: {}, bColorFlag: true, mode: "single" },
      true
    );
  ...
  describe("onAction - method", () => {
    test("no items", async () => {
      wrapper = initComponent(
        Items,
        { items: [], filter: new Map(), bColorFlag: true },
        true
      );
    ...
    test("item exists", async () => {
      ...
      wrapper = initComponent(
        Items,
        { items: [item], filter: new Map(), bColorFlag: true },
        true
      );
  ...
  describe("isFiltered - method", () => {
    ...
    test("filter exists", async () => {
      ...
      wrapper = initComponent(
        Items,
        { items: [item1], filter: filter, bColorFlag: true },
        true
      );
