...
export default class GuideViewProvider implements vscode.WebviewViewProvider {
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    const scriptUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionUri, "resources", "center", "main.js")
    );
    const styleMainUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionUri, "resources", "center", "main.css")
    );
    const codeIconStyleUri = webview.asWebviewUri(
      vscode.Uri.joinPath(
        this._extensionUri,
        "resources",
        "center",
