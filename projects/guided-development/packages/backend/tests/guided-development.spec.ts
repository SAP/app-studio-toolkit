...
describe("guidedDevelopment unit test", () => {
  ...
  const guidedDevelopment: GuidedDevelopment = new GuidedDevelopment(
    rpc,
    appEvents,
    outputChannel,
    testLogger,
  ...
  describe("performAction", () => {
    ...
    it("no context", async () => {
      ...
      appEventsMock
        ...
        .withExactArgs(item1.action1.action);
      await guidedDevelopment["setCollections"]([collection1]);
    ...
    it("execute command action - without context", async () => {
      ...
      appEventsMock
        ...
        .withExactArgs(item1.action1.action);
      await guidedDevelopment["setCollections"]([collection1]);
      await guidedDevelopment["performAction"](
        fqid1,
        1,
        new testExecuteItemContext()
      );
    });
    ...
    it("command action, with context, index 2", async () => {
      ...
      appEventsMock
        .expects("performAction")
        .withExactArgs(item1.action2.action);
      await guidedDevelopment["setCollections"]([collection1]);
